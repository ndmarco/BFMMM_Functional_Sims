...
int_err_mean3 <- matrix(0, 25, 3)
int_err_cov12 <- matrix(0, 25, 3)
int_err_cov1 <- matrix(0, 25, 3)
int_err_cov2 <- matrix(0, 25, 3)
int_err_cov3 <- matrix(0, 25, 3)
int_err_cov13 <- matrix(0, 25, 3)
int_err_cov23 <- matrix(0, 25, 3)
...
norm_mu3 <- matrix(1, nrow = 25, ncol = 3)
norm_C1 <- matrix(1, nrow = 25, ncol = 3)
norm_C2 <- matrix(1, nrow = 25, ncol = 3)
norm_C3 <- matrix(1, nrow = 25, ncol = 3)
norm_C12 <- matrix(1, nrow = 25, ncol = 3)
norm_C13 <- matrix(1, nrow = 25, ncol = 3)
norm_C23 <- matrix(1, nrow = 25, ncol = 3)
...
rescale_function <- function(Z){
  ...
  inv_trans <- solve(triangle, tol = 1e-30)
  trans_Z <- Z %*% inv_trans
...
for(j in 1:3){
  ...
  for(i in 1:25){
    ...
    for(iter in 1:9000){
      ...
      if(!inherits(obj, "try-error")){
        ...
        if(iter > 1){
          ...
          obj <- try(rescale_function(Z_est$Z_trace[,,iter + 1]), silent = T)
          if(!inherits(obj, "try-error")){
            Z_rescaled[,,iter] <- obj$rescaled_Z
            trans_mat[((iter-1)*3 + 1):(iter*3), ] = obj$t_mat
            # potential label switching
    ...
    int_err_mean3[i,j] <- sum((nu_3$CI_50 - nu_3_true)^2) * 20
    int_err_cov1[i,j] <- sum((cov1$CI_50 - cov1_true)^2) * 400
    int_err_cov2[i,j] <- sum((cov2$CI_50 - cov2_true)^2) * 400
    int_err_cov3[i,j] <- sum((cov3$CI_50 - cov3_true)^2) * 400
    int_err_cov12[i,j] <- sum((cov12$CI_50 - cov12_true)^2) * 400
    int_err_cov13[i,j] <- sum((cov13$CI_50 - cov13_true)^2) * 400
    int_err_cov23[i,j] <- sum((cov23$CI_50 - cov23_true)^2) * 400
    ...
    norm_mu3[i,j] <- sum((nu_3_true)^2) * 20
    norm_C1[i,j] <- sum((cov1_true)^2) * 400
    norm_C2[i,j] <- sum((cov2_true)^2) * 400
    norm_C3[i,j] <- sum((cov3_true)^2) * 400
    norm_C12[i,j] <- sum((cov12_true)^2) * 400
    norm_C13[i,j] <- sum((cov13_true)^2) * 400
    norm_C23[i,j] <- sum((cov23_true)^2) * 400
...
C3_RMSE <- matrix(0, 75, 2)
C3_RMSE[1:25,1] <- (int_err_cov3[,1] / norm_C3[,1])
C3_RMSE[1:25,2] <- 50
C3_RMSE[26:50,1] <- (int_err_cov3[,2] / norm_C3[,2])
C3_RMSE[26:50,2] <- 100
C3_RMSE[51:75,1] <- (int_err_cov3[,3] / norm_C3[,3])
C3_RMSE[51:75,2] <- 200
...
C23_RMSE <- matrix(0, 75, 2)
C23_RMSE[1:25,1] <- (int_err_cov23[,1] / norm_C23[,1])
C23_RMSE[1:25,2] <- 50
C23_RMSE[26:50,1] <- (int_err_cov23[,2] / norm_C23[,2])
C23_RMSE[26:50,2] <- 100
C23_RMSE[51:75,1] <- (int_err_cov23[,3] / norm_C23[,3])
C23_RMSE[51:75,2] <- 200
...
C13_RMSE <- matrix(0, 75, 2)
C13_RMSE[1:25,1] <- (int_err_cov13[,1] / norm_C13[,1])
C13_RMSE[1:25,2] <- 50
C13_RMSE[26:50,1] <- (int_err_cov13[,2] / norm_C13[,2])
C13_RMSE[26:50,2] <- 100
C13_RMSE[51:75,1] <- (int_err_cov13[,3] / norm_C13[,3])
C13_RMSE[51:75,2] <- 200
...
# Plot R-MISE for the mean function of feature 1
mu3_RMSE <- matrix(0, 75, 2)
mu3_RMSE[1:25,1] <- (int_err_mean3[,1] / norm_mu3[,1])
mu3_RMSE[1:25,2] <- 50
mu3_RMSE[26:50,1] <- (int_err_mean3[,2] / norm_mu3[,2])
mu3_RMSE[26:50,2] <- 100
mu3_RMSE[51:75,1] <- (int_err_mean3[,3] / norm_mu3[,3])
mu3_RMSE[51:75,2] <- 200
